...
const Creators = () => (
	<Layout>
		<div className="h-screen w-screen bg-gray-100 dark:bg-inherit flex items-center">
			<div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700 dark:text-slate-300">
				...
				<div className="max-w-lg">
					...
					>
						<defs></defs>
						<title>404 Page not forund.</title>
						<path
							className="cls-1"
