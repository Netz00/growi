		...
		<div
			className={`${
				!props.savePopup && 'hidden'
                            ...
                            h-fit w-auto bg-white z-10 dark:bg-gray-800
                            border-solid border border-black dark:border-gray-700 rounded-lg`}
		>
			<div className="flex flex-col gap-3 p-5">
				<div className="flex flex-row justify-between align-middle">
					<span className="h-fit dark:text-gray-500">Save to ...</span>{' '}
					<Clickable
						onClick={() => {
					...
					{lists.map((list, key) => (
						...
						>
							...
							<label
								...
								className="text-sm hover:cursor-pointer flex-grow dark:text-gray-500"
							>
								{list}
							</label>
						</div>
				...
				{addNew && (
					<div>
						...
						<input
							...
							type="text"
							id="first_name"
							className="bg-gray-50 dark:bg-gray-800 dark:placeholder-gray-600 border border-gray-300 text-gray-900 dark:text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
